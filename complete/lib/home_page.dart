...
import 'package:pim/service/user_db_service.dart';
        ...
        child: Column(
          children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (activeSubId == sub1Id)
                      GestureDetector(
                        onTap: () {
                          if (_activeSubscriptionPurchasesDetails != null) {
                            confirmPriceChange(context,
                                _activeSubscriptionPurchasesDetails!.productID);
                          }
                        },
                        child: Container(
            ...
            Align(
              ...
              child: Text('Description : monthly subscription plan',
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            Align(
              alignment: Alignment.centerLeft,
              child: Text('Description : yearly subscription plan',
                  style: TextStyle(color: c3, fontSize: 16)),
            ),
            const SizedBox(
              height: 20,
